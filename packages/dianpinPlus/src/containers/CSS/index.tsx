          ...
          <div>
            <div id={styles["common-header"]}>
              <span
                ...
                onClick={this.currentback.bind(this)}
              >
                <i className="icon-chevron-left"></i>
              </span>
              <h1>{this.state.title}</h1>
            </div>
            <div id={styles["css-content"]}>{this.switchState()}</div>
          </div>
        ) : (
          <div>
            ...
            <div id={styles["css-list"]}>
              <ul>
                <li onClick={this.changeType.bind(this, "center", "css居中")}>
                  1.css显示居中
                </li>
                <li onClick={this.changeType.bind(this, "animate", "css动画")}>
                  2.css动画
                </li>
              </ul>
            </div>
