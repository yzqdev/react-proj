...
import animatestyles from "./animate.module.less";
...
class Animate extends Component {
  ...
  render() {
    return (
      <div id={animatestyles["animate"]}>
        <div
          id={animatestyles["animate1"]}
          className={animatestyles["animate-list"]}
          ref="animate1"
        >
        ...
        <div
          id={animatestyles["animate2"]}
          className={animatestyles["animate-list"]}
          ref="animate2"
        >
          <div className={animatestyles["animate-title"]}>
            <div
              className={animatestyles["item"] + " " + animatestyles["item1"]}
            >
              旋转1
            </div>
            <div
              className={animatestyles["item"] + " " + animatestyles["item2"]}
            >
              旋转2
            </div>
        ...
        <div
          id={animatestyles["animate3"]}
          className={animatestyles["animate-list"]}
          ref="animate3"
        >
          <div className={animatestyles["item"]}>翻转</div>
          <div className={styles["content"]} ref="content3">
            <pre></pre>
          </div>
        </div>
      </div>
  ...
  componentDidMount() {
    ...
    content.map((item, index) => {
      item.getElementsByTagName("pre")[0].innerHTML = Prism.highlight(
        StyleData[index],
        Prism.languages.css
      );
